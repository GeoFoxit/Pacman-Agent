...
class FroggerAgent(Agent):
    ...
    def getAction(self, state):
        ...
        #P#_1
        ###
        if state.getGhostPosition(1)[0]-state.getPacmanPosition()[0] == 1 and state.getGhostPosition(1)[1]-state.getPacmanPosition()[1] == 1:
                # print "hello1"
                near=1
        ...
        #PG_1
        ###
        elif state.getGhostPosition(1)[1] == state.getPacmanPosition()[1] and state.getGhostPosition(1)[0]-state.getPacmanPosition()[0] == 1:
            near=1
            # print "222"
            if state.getGhostState(1).getDirection() == Directions.WEST:
        ...
        #P#_1
        #G#
        elif state.getGhostPosition(1)[1]-state.getPacmanPosition()[1] == -1 and state.getGhostPosition(1)[0] == state.getPacmanPosition()[0]:
                # print "2"
                near=1
        ...
        #P#_1
        ##G
        elif state.getGhostPosition(1)[0]-state.getPacmanPosition()[0] == 1 and state.getGhostPosition(1)[1]-state.getPacmanPosition()[1] == -1:
                
                near=1
                if state.getGhostState(1).getDirection() == Directions.WEST or state.getGhostState(1).getDirection() == Directions.EAST: #project bug??
                    #print "3"
                    s=-1
                    if Directions.EAST in state.getLegalPacmanActions():###wall
                        #print "8"
        ...
        #P#_2
        ###
        if state.getGhostPosition(2)[0]-state.getPacmanPosition()[0] == 1 and state.getGhostPosition(2)[1]-state.getPacmanPosition()[1] == 1:
                # print "6"
                near=1
        ...
        #PG_2
        ###
        elif state.getGhostPosition(2)[1] == state.getPacmanPosition()[1] and state.getGhostPosition(2)[0]-state.getPacmanPosition()[0] == 1: 
            # print "7"
            near=1
            if state.getGhostState(2).getDirection() == Directions.WEST:
        ...
        #P#_2
        ##G
        elif state.getGhostPosition(2)[0]-state.getPacmanPosition()[0] == 1 and state.getGhostPosition(2)[1]-state.getPacmanPosition()[1] == -1:
                # print "9"
                near=1
                if state.getGhostState(2).getDirection() == Directions.WEST:
...
class SnakeAgent(Agent):
	...
	if Directions.EAST in state.getLegalPacmanActions():
		if (pacman_pos[0]+1 == ghost_pos_1_x or pacman_pos[0]+2 == ghost_pos_2_x or pacman_pos[0]+1 == ghost_pos_2_x or pacman_pos[0]+2 == ghost_pos_1_x):
			if(pacman_pos[1]-ghost_pos_2_y==0 or pacman_pos[1]-ghost_pos_2_y==-1 or pacman_pos[1]-ghost_pos_2_y==1):
